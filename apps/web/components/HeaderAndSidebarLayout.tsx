...
import { Users, Route as RouteIcon, UserCheck } from 'lucide-react';
...
export default function HeaderAndSidebarLayout({
 ...
 const navItems = (role === 'COACH' || role === 'ADMIN')
   ? [
       ...
       { href: '/coach/assign', icon: UserCheck, label: 'Assign' },
   ...
   ? [
       ...
       { href: '/player/queue', icon: ClipboardList, label: 'Queue' },
       { href: '/calendar', icon: CalendarDays, label: 'Calendar' },
