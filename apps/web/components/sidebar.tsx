...
export default function Sidebar({expanded}:{expanded:boolean}){
 return (
  <aside className={`bg-white border-r overflow-hidden transition-all duration-300 ease-in-out ${expanded ? 'fixed md:static top-14 bottom-0 left-0 z-40 w-64 md:h-full' : 'hidden'}`}>
